"""
Unit tests for drugs_comparison module.
...
# from medkit.medkit.drug.drugs_comparison import ClassName


class TestDrugsComparisonModels(unittest.TestCase):
    """Test drugs_comparison data models and classes."""
...
class TestDrugsComparisonIntegration(unittest.TestCase):
    """Integration tests for drugs_comparison module."""
