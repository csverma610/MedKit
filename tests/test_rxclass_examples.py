"""
Unit tests for rxclass_examples module.
...
# from medkit.medkit.drug.rxclass_examples import ClassName


class TestRxclassExamplesModels(unittest.TestCase):
    """Test rxclass_examples data models and classes."""
...
class TestRxclassExamplesIntegration(unittest.TestCase):
    """Integration tests for rxclass_examples module."""
