"""
Unit tests for similar_drugs module.
...
# from medkit.medkit.drug.similar_drugs import ClassName


class TestSimilarDrugsModels(unittest.TestCase):
    """Test similar_drugs data models and classes."""
...
class TestSimilarDrugsIntegration(unittest.TestCase):
    """Integration tests for similar_drugs module."""
