"""
Unit tests for surgery_info module.
...
# from medkit.medkit.medical.surgery_info import ClassName


class TestSurgeryInfoModels(unittest.TestCase):
    """Test surgery_info data models and classes."""
...
class TestSurgeryInfoIntegration(unittest.TestCase):
    """Integration tests for surgery_info module."""
