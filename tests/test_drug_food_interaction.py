"""
Unit tests for drug_food_interaction module.
...
# from medkit.medkit.drug.drug_food_interaction import ClassName


class TestDrugFoodInteractionModels(unittest.TestCase):
    """Test drug_food_interaction data models and classes."""
...
class TestDrugFoodInteractionIntegration(unittest.TestCase):
    """Integration tests for drug_food_interaction module."""
