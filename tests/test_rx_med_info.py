"""
Unit tests for rx_med_info module.
...
# from medkit.medkit.drug.rx_med_info import ClassName


class TestRxMedInfoModels(unittest.TestCase):
    """Test rx_med_info data models and classes."""
...
class TestRxMedInfoIntegration(unittest.TestCase):
    """Integration tests for rx_med_info module."""
