"""
Unit tests for exam_blood_vessels module.
...
# from medkit.medkit.phyexams.exam_blood_vessels import ClassName


class TestExamBloodVesselsModels(unittest.TestCase):
    """Test exam_blood_vessels data models and classes."""
...
class TestExamBloodVesselsIntegration(unittest.TestCase):
    """Integration tests for exam_blood_vessels module."""
