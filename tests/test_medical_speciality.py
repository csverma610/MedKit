"""
Unit tests for medical_speciality module.
...
# from medkit.medkit.medical.medical_speciality import ClassName


class TestMedicalSpecialityModels(unittest.TestCase):
    """Test medical_speciality data models and classes."""
...
class TestMedicalSpecialityIntegration(unittest.TestCase):
    """Integration tests for medical_speciality module."""
