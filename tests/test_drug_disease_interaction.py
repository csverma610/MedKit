"""
Unit tests for drug_disease_interaction module.
...
# from medkit.medkit.drug.drug_disease_interaction import ClassName


class TestDrugDiseaseInteractionModels(unittest.TestCase):
    """Test drug_disease_interaction data models and classes."""
...
class TestDrugDiseaseInteractionIntegration(unittest.TestCase):
    """Integration tests for drug_disease_interaction module."""
