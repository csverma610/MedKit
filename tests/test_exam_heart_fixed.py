"""
Unit tests for exam_heart_fixed module.
...
# from medkit.medkit.phyexams.exam_heart_fixed import ClassName


class TestExamHeartFixedModels(unittest.TestCase):
    """Test exam_heart_fixed data models and classes."""
...
class TestExamHeartFixedIntegration(unittest.TestCase):
    """Integration tests for exam_heart_fixed module."""
