"""
Unit tests for sane_interview module.
...
# from medkit.medkit.mental_health.sane_interview import ClassName


class TestSaneInterviewModels(unittest.TestCase):
    """Test sane_interview data models and classes."""
...
class TestSaneInterviewIntegration(unittest.TestCase):
    """Integration tests for sane_interview module."""
