...
# from medkit.medkit.core.gemini_client import ClassName


class TestGeminiClientModels(unittest.TestCase):
    """Test gemini_client data models and classes."""
...
class TestGeminiClientIntegration(unittest.TestCase):
    """Integration tests for gemini_client module."""
