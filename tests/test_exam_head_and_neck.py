"""
Unit tests for exam_head_and_neck module.
...
# from medkit.medkit.phyexams.exam_head_and_neck import ClassName


class TestExamHeadAndNeckModels(unittest.TestCase):
    """Test exam_head_and_neck data models and classes."""
...
class TestExamHeadAndNeckIntegration(unittest.TestCase):
    """Integration tests for exam_head_and_neck module."""
