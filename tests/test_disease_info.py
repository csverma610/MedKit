"""
Unit tests for disease_info module.
...
# from medkit.medkit.medical.disease_info import ClassName


class TestDiseaseInfoModels(unittest.TestCase):
    """Test disease_info data models and classes."""
...
class TestDiseaseInfoIntegration(unittest.TestCase):
    """Integration tests for disease_info module."""
