"""
Unit tests for medical_test_info module.
...
# from medkit.medkit.diagnostics.medical_test_info import ClassName


class TestMedicalTestInfoModels(unittest.TestCase):
    """Test medical_test_info data models and classes."""
...
class TestMedicalTestInfoIntegration(unittest.TestCase):
    """Integration tests for medical_test_info module."""
