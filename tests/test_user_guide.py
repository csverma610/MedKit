"""
Unit tests for user_guide module.
...
# from medkit.medkit.medical.user_guide import ClassName


class TestUserGuideModels(unittest.TestCase):
    """Test user_guide data models and classes."""
...
class TestUserGuideIntegration(unittest.TestCase):
    """Integration tests for user_guide module."""
