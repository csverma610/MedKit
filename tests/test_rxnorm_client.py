"""
Unit tests for rxnorm_client module.
...
# from medkit.medkit.drug.rxnorm_client import ClassName


class TestRxnormClientModels(unittest.TestCase):
    """Test rxnorm_client data models and classes."""
...
class TestRxnormClientIntegration(unittest.TestCase):
    """Integration tests for rxnorm_client module."""
