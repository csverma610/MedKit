"""
Unit tests for drug_drug_interaction module.
...
# from medkit.medkit.drug.drug_drug_interaction import ClassName


class TestDrugDrugInteractionModels(unittest.TestCase):
    """Test drug_drug_interaction data models and classes."""
...
class TestDrugDrugInteractionIntegration(unittest.TestCase):
    """Integration tests for drug_drug_interaction module."""
